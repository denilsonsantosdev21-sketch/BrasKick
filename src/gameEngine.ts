...
const REAL_PLAYERS_DATA: Record<string, any[]> = {
  ...
  "São Paulo": [
    { name: "Lucas Moura", nationality: "Brasil", position: "MF", overall: 79 },
    { name: "Jonathan Calleri", nationality: "Argentina", position: "FW", overall: 78 },
    { name: "Robert Arboleda", nationality: "Equador", position: "DF", overall: 77 },
    { name: "Rafael", nationality: "Brasil", position: "GK", overall: 77 },
    { name: "Luiz Gustavo", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Luciano", nationality: "Brasil", position: "FW", overall: 76 },
    { name: "Alan Franco", nationality: "Argentina", position: "DF", overall: 75 },
    { name: "Ferreira", nationality: "Brasil", position: "FW", overall: 75 },
    { name: "Igor Vinícius", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Welington", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Damián Bobadilla", nationality: "Paraguai", position: "MF", overall: 73 },
    { name: "Alisson", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Pablo Maia", nationality: "Brasil", position: "MF", overall: 77 },
    { name: "Michel Araújo", nationality: "Uruguai", position: "MF", overall: 74 }
  ],
  "Corinthians": [
    { name: "Memphis Depay", nationality: "Holanda", position: "FW", overall: 82 },
    { name: "Rodrigo Garro", nationality: "Argentina", position: "MF", overall: 77 },
    { name: "Yuri Alberto", nationality: "Brasil", position: "FW", overall: 76 },
    { name: "André Ramalho", nationality: "Brasil", position: "DF", overall: 76 },
    { name: "Fagner", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Hugo Souza", nationality: "Brasil", position: "GK", overall: 74 },
    { name: "Talles Magno", nationality: "Brasil", position: "FW", overall: 74 },
    { name: "José Martínez", nationality: "Venezuela", position: "MF", overall: 74 },
    { name: "Gustavo Henrique", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Charles", nationality: "Brasil", position: "MF", overall: 73 },
    { name: "Matheus Bidu", nationality: "Brasil", position: "DF", overall: 72 },
    { name: "Breno Bidon", nationality: "Brasil", position: "MF", overall: 71 },
    { name: "Igor Coronado", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Alex Santana", nationality: "Brasil", position: "MF", overall: 74 }
  ],
  "Atlético-MG": [
    { name: "Hulk", nationality: "Brasil", position: "FW", overall: 80 },
    { name: "Paulinho", nationality: "Brasil", position: "FW", overall: 79 },
    { name: "Guilherme Arana", nationality: "Brasil", position: "DF", overall: 79 },
    { name: "Gustavo Scarpa", nationality: "Brasil", position: "MF", overall: 78 },
    { name: "Everson", nationality: "Brasil", position: "GK", overall: 78 },
    { name: "Matías Zaracho", nationality: "Argentina", position: "MF", overall: 77 },
    { name: "Rodrigo Battaglia", nationality: "Argentina", position: "DF", overall: 77 },
    { name: "Junior Alonso", nationality: "Paraguai", position: "DF", overall: 77 },
    { name: "Otávio", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Alan Franco", nationality: "Equador", position: "MF", overall: 75 },
    { name: "Renzo Saravia", nationality: "Argentina", position: "DF", overall: 75 }
  ],
  "Grêmio": [
    { name: "Martin Braithwaite", nationality: "Dinamarca", position: "FW", overall: 77 },
    { name: "Mathías Villasanti", nationality: "Paraguai", position: "MF", overall: 77 },
    { name: "Yeferson Soteldo", nationality: "Venezuela", position: "FW", overall: 76 },
    { name: "Franco Cristaldo", nationality: "Argentina", position: "MF", overall: 76 },
    { name: "Agustín Marchesín", nationality: "Argentina", position: "GK", overall: 76 },
    { name: "Cristian Pavón", nationality: "Argentina", position: "FW", overall: 75 },
    { name: "Jemerson", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "João Pedro", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Rodrigo Ely", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Reinaldo", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Dodi", nationality: "Brasil", position: "MF", overall: 73 }
  ],
  "Internacional": [
    { name: "Alan Patrick", nationality: "Brasil", position: "MF", overall: 79 },
    { name: "Rafael Borré", nationality: "Colômbia", position: "FW", overall: 78 },
    { name: "Enner Valencia", nationality: "Equador", position: "FW", overall: 78 },
    { name: "Sergio Rochet", nationality: "Uruguai", position: "GK", overall: 78 },
    { name: "Vitão", nationality: "Brasil", position: "DF", overall: 76 },
    { name: "Fernando", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Wesley", nationality: "Brasil", position: "FW", overall: 75 },
    { name: "Thiago Maia", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "Agustín Rogel", nationality: "Uruguai", position: "DF", overall: 74 },
    { name: "Alexandro Bernabei", nationality: "Argentina", position: "DF", overall: 73 },
    { name: "Bruno Gomes", nationality: "Brasil", position: "DF", overall: 72 }
  ],
  "Cruzeiro": [
    { name: "Matheus Pereira", nationality: "Brasil", position: "MF", overall: 79 },
    { name: "Cássio", nationality: "Brasil", position: "GK", overall: 77 },
    { name: "William", nationality: "Brasil", position: "DF", overall: 76 },
    { name: "Walace", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "Marlon", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Álvaro Barreal", nationality: "Argentina", position: "MF", overall: 75 },
    { name: "Zé Ivaldo", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Lucas Romero", nationality: "Argentina", position: "MF", overall: 74 },
    { name: "Gabriel Veron", nationality: "Brasil", position: "FW", overall: 74 },
    { name: "Kaio Jorge", nationality: "Brasil", position: "FW", overall: 74 },
    { name: "João Marcelo", nationality: "Brasil", position: "DF", overall: 74 }
  ],
  "Fluminense": [
    { name: "Thiago Silva", nationality: "Brasil", position: "DF", overall: 80 },
    { name: "Jhon Arias", nationality: "Colômbia", position: "MF", overall: 79 },
    { name: "Germán Cano", nationality: "Argentina", position: "FW", overall: 78 },
    { name: "Marcelo", nationality: "Brasil", position: "DF", overall: 78 },
    { name: "Paulo Henrique Ganso", nationality: "Brasil", position: "MF", overall: 77 },
    { name: "Fábio", nationality: "Brasil", position: "GK", overall: 77 },
    { name: "Martinelli", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "Samuel Xavier", nationality: "Brasil", position: "DF", overall: 74 },
  ...
  "Vasco": [
    ...
    { name: "Pablo Vegetti", nationality: "Argentina", position: "FW", overall: 78 },
    { name: "Léo Jardim", nationality: "Brasil", position: "GK", overall: 77 },
    { name: "João Victor", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Lucas Piton", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Adson", nationality: "Brasil", position: "FW", overall: 74 },
    { name: "Paulo Henrique", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Maicon", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Hugo Moura", nationality: "Brasil", position: "MF", overall: 73 },
    { name: "Mateus Carvalho", nationality: "Brasil", position: "MF", overall: 72 },
    { name: "Emerson Rodríguez", nationality: "Colômbia", position: "FW", overall: 72 }
  ],
  "Bahia": [
    { name: "Everton Ribeiro", nationality: "Brasil", position: "MF", overall: 77 },
    { name: "Cauly", nationality: "Brasil", position: "MF", overall: 76 },
    { name: "Caio Alexandre", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "Jean Lucas", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "Marcos Felipe", nationality: "Brasil", position: "GK", overall: 74 },
    { name: "Thaciano", nationality: "Brasil", position: "FW", overall: 74 },
    { name: "Santiago Arias", nationality: "Colômbia", position: "DF", overall: 74 },
    { name: "Gabriel Xavier", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Kanu", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Luciano Juba", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Everaldo", nationality: "Brasil", position: "FW", overall: 73 }
  ],
  "Fortaleza": [
    { name: "Juan Martín Lucero", nationality: "Argentina", position: "FW", overall: 77 },
    { name: "Tomás Pochettino", nationality: "Argentina", position: "MF", overall: 76 },
    { name: "Yago Pikachu", nationality: "Brasil", position: "MF", overall: 75 },
    { name: "João Ricardo", nationality: "Brasil", position: "GK", overall: 75 },
    { name: "Tinga", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Benjamin Kuscevic", nationality: "Chile", position: "DF", overall: 74 },
    { name: "Bruno Pacheco", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Hércules", nationality: "Brasil", position: "MF", overall: 74 },
    { name: "Titi", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Lucas Sasha", nationality: "Brasil", position: "MF", overall: 73 },
    { name: "Breno Lopes", nationality: "Brasil", position: "FW", overall: 73 }
  ],
  "Athletico Paranaense": [
    { name: "Fernandinho", nationality: "Brasil", position: "MF", overall: 77 },
    { name: "Gonzalo Mastriani", nationality: "Uruguai", position: "FW", overall: 76 },
    { name: "Thiago Heleno", nationality: "Brasil", position: "DF", overall: 75 },
    { name: "Lucas Esquivel", nationality: "Argentina", position: "DF", overall: 75 },
    { name: "Bruno Zapelli", nationality: "Argentina", position: "MF", overall: 75 },
    { name: "Agustín Canobbio", nationality: "Uruguai", position: "FW", overall: 75 },
    { name: "Kaique Rocha", nationality: "Brasil", position: "DF", overall: 74 },
    { name: "Erick", nationality: "Brasil", position: "MF", overall: 74 },
    { name: "Madson", nationality: "Brasil", position: "DF", overall: 73 },
    { name: "Tomás Cuello", nationality: "Argentina", position: "FW", overall: 73 },
    { name: "Mycael", nationality: "Brasil", position: "GK", overall: 72 }
  ]
};
